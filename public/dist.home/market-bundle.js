...
// module
exports.push([module.i, ".app-header {\n  text-align: center;\n  background-color: #222;\n  padding: 20px;\n  color: #eee;\n}\n\n.header-title {\n  font-size: 1.5em;\n}\n\n.app-content {\n  font-size: large;\n  padding: 2em;\n}\n\n.app-footer {\n  text-align: center;\n  background-color: #222;\n  color: #eee;\n  padding: 10px;\n}\n\n.repo, .issue {\n  margin: 10px;\n}\n\n#repos-content {\n  box-sizing: border-box;\n  display: flex;\n  flex-wrap: wrap;\n  flex: 1;\n  /* justify-content: center; */\n  list-style: none;\n}\n\n#repos-content .repo-card {\n  width: 18rem;\n  padding: 10px;\n  max-height: 135px;\n  min-height: 135px;\n  font-size: 14px;\n}\n\n#repos-content .repo-title {\n  text-decoration: none;\n}\n\n#repos-content .repo-card-footer {\n  background: #222;\n}\n\n#repos-content .repo-view-issues {\n  color: #eee;\n}\n\n#repos-content \n.repo-view-issues:hover {\n  color: rgba(238, 238, 238, 0.63);\n}\n\n#issue-list {\n  list-style: none;\n  display: flex;\n  flex-wrap: wrap;\n  padding: 0 auto;\n}\n\n#issue-list li {\n  max-width: 25%;\n  flex: 0 1 25%;\n  margin: 10px 0px; /* fits 4 into one line */\n}\n\n#issue-list .issue-card {\n  width: 18rem;\n  padding: 10px;\n  background: #eee;\n}\n\n#issue-list .issue-title {\n  font-size: 17px;\n}\n\n#issue-list .issue-price {\n  color: green;\n  font-weight: bold;\n  padding: 3px;\n  font-size: 14px;\n}\n\n#issue-list .issue-assignee {\n  font-size: 14px;\n}\n\n#issue-list .issue-due-date,\n.issue-card-footer {\n  font-size: 12px\n}\n\n#issue-list .issue-card-footer {\n  background: none;\n}\n\n.issue {\n  width: 100px;\n}", ""]);
...
var SearchBar = function SearchBar(_ref) {
  ...
  return _react2.default.createElement(
    "div",
    { className: "input-group mb-3", style: styles.searchBar },
...
var _ReposPage = __webpack_require__(126);

var _ReposPage2 = _interopRequireDefault(_ReposPage);

var _IssuesPage = __webpack_require__(146);

var _IssuesPage2 = _interopRequireDefault(_IssuesPage);
...
var routes = function routes() {
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_reactRouterDom.Route, { exact: true, path: '/market', component: _ReposPage2.default }),
            _react2.default.createElement(_reactRouterDom.Route, { path: '/:user/:repo/issues', component: _IssuesPage2.default })
        )
    );
};
...
var _Repo = __webpack_require__(145);
...
var repos_url = _config2.default.init().githubrepo.repos_url;

var ReposPage = function (_Component) {
  _inherits(ReposPage, _Component);

  function ReposPage(props) {
    _classCallCheck(this, ReposPage);

    var _this = _possibleConstructorReturn(this, (ReposPage.__proto__ || Object.getPrototypeOf(ReposPage)).call(this, props));
  ...
  _createClass(ReposPage, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      // Fetch repositories for given user  
      _axios2.default.get(repos_url).then(function (res) {
        // Save data to state
        _this2.setState({
          repos: res.data,
          loaded: true
    ...
    key: 'showReposCount',
    value: function showReposCount() {
      // Determines proper grammar based on number of repos available
      return this.state.repos.length > 1 ? this.state.repos.length + ' repositories available' : this.state.repos.length + ' repository available';
    }
  }, {
    key: 'renderPage',
    value: function renderPage() {
      ...
      if (this.state.loaded) {
        ...
        if (this.state.repos.length > 0) {
          ...
          var filteredRepos = this.state.repos.filter(function (repo) {
            return repo.name.toLowerCase().includes(_this3.state.search);
          });
          var repos = filteredRepos.map(function (repo) {
            return _react2.default.createElement(_Repo2.default, { key: repo.id, repo: repo });
          });
          return repos;
        } else {
          ...
          return _react2.default.createElement(
            'p',
            null,
            'Did not find repositories with issues for user ',
            _react2.default.createElement(
              'strong',
              null,
              this.state.user
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'span',
          { id: 'repos-count', className: 'd-flex justify-content-center' },
          this.state.loaded && this.state.repos.length > 0 ? this.showReposCount() : null
        ),
        _react2.default.createElement(_SearchBar2.default, { value: this.state.search,
...
var Repo = function Repo(_ref) {
  ...
  return _react2.default.createElement(
    'li',
    { id: repo.id, className: 'repo' },
    _react2.default.createElement(
      'div',
      { className: 'card text-center repo-card' },
      _react2.default.createElement(
        'div',
        { className: 'card-body' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: repo.html_url, target: '_blank', className: 'repo-title' },
          _react2.default.createElement(
            'h5',
    ...
    _react2.default.createElement(
      'div',
      { className: 'card-footer text-center repo-card-footer' },
      _react2.default.createElement(
        _reactRouterDom.Link,
        { to: '/' + repo.owner.login + '/' + repo.name + '/issues',
...
var _Issue = __webpack_require__(147);

var _Issue2 = _interopRequireDefault(_Issue);

var _Navigation = __webpack_require__(148);

var _Navigation2 = _interopRequireDefault(_Navigation);

var _IssuesFilterBy = __webpack_require__(149);

var _IssuesFilterBy2 = _interopRequireDefault(_IssuesFilterBy);
...
var issues_url = _config2.default.init().githubrepo.issues_url;

var IssuesPage = function (_Component) {
  _inherits(IssuesPage, _Component);

  function IssuesPage(props) {
    _classCallCheck(this, IssuesPage);

    var _this = _possibleConstructorReturn(this, (IssuesPage.__proto__ || Object.getPrototypeOf(IssuesPage)).call(this, props));

    _this.state = {
      repo: _this.props.match.params.repo,
      loaded: false,
      criteria: 'open',
      search: '',
      issues: []
  ...
  _createClass(IssuesPage, [{
    key: 'componentDidMount',
    value: function componentDidMount() {
      var _this2 = this;

      var repo = this.state.repo;
      var endpoint = issues_url + '/' + repo;
      // Fetch issues for repo and save them into state
      _axios2.default.get(endpoint).then(function (res) {
        _this2.setState({
          issues: res.data,
          loaded: true
        });
    ...
    value: function renderPage() {
      ...
      var filteredIssues = this.state.issues.filter(function (issue) {
        return issue.title.toLowerCase().includes(_this3.state.search);
      });
      // Create issue components based on current *filtering criteria*.
      if (this.state.criteria === 'open') {
        issues = filteredIssues.filter(function (issue) {
          return issue.stage === 'open';
        });
        issues = issues.map(function (issue) {
          return _react2.default.createElement(_Issue2.default, { key: issue.number, issue: issue });
        });
      } else if (this.state.criteria === 'active') {
        issues = filteredIssues.filter(function (issue) {
          return issue.stage === 'active';
        });
        issues = issues.map(function (issue) {
          return _react2.default.createElement(_Issue2.default, { key: issue.number, issue: issue });
        });
      ...
      return issues.length > 0 ? issues : _react2.default.createElement(
        'p',
        null,
        'No ',
        this.state.criteria,
    ...
    value: function handleCriteriaChange(criteria) {
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_IssuesFilterBy2.default, {
...
var Issue = function Issue(_ref) {
  ...
  return _react2.default.createElement(
    'li',
    { id: issue.id, number: issue.number, className: 'issue' },
    _react2.default.createElement(
      'div',
      { className: 'card text-center issue-card' },
      _react2.default.createElement(
        'div',
        { className: 'card-body' },
        _react2.default.createElement(
          'h5',
          { className: 'card-title issue-title' },
          issue.title
        ),
        _react2.default.createElement(
          'h6',
          { className: 'card-subtitle mb-2 issue-price' },
          '$' + issue.price
        ),
        _react2.default.createElement(
          'p',
          { className: 'card-text issue-assignee' },
          issue.stage === 'active' ? 'Assigned to: ' + issue.assignee : ''
        ),
        _react2.default.createElement(
          'span',
          { className: 'card-text text-muted issue-due-date' },
          'Due on: ',
          issue.due_date
        )
      ),
      _react2.default.createElement(
        'div',
        { className: 'card-footer text-center issue-card-footer' },
        _react2.default.createElement(
          _reactRouterDom.Link,
          { to: issue.html_url, target: '_blank' },
          _react2.default.createElement(
            'span',
            { className: '' },
            'View on GitHub'
...
var FilterBy = function FilterBy(_ref) {
  var handleCriteriaChange = _ref.handleCriteriaChange,
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      { type: "button",
        onClick: function onClick() {
          return handleCriteriaChange('open');
        },
    ...
    _react2.default.createElement(
      ...
      { type: "button",
        onClick: function onClick() {
          return handleCriteriaChange('active');
        },
    ...
    _react2.default.createElement(
      ...
      { type: "button",
        onClick: function onClick() {
          return handleCriteriaChange('closed');
        },
