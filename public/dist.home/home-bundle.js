...
var App = function (_Component) {
  ...
  _createClass(App, [{
    ...
    value: function getPortfolioData() {
      ...
      //Ajax request
      fetch(origin + '/home/static/portfolioData.json').then(function (r) {
        return r.json();
      }).then(function (json) {
        _this2.db = json;
      ...
      value: function render() {
         if (this.props.data) {
            var portfolio = this.props.data.projects.map(function (project) {
               var imageUrl = 'home/static/images/portfolio/' + project.image;
               return _react2.default.createElement(
                  'div',
...
module.exports = {"org":{"name":"Strategic Machines","addr1":"100 Main Street","addr2":"Suite 100","city":"Charlotte","state":"NC","zip":"28211","url":"www.strategicmachines.io","contact":"ChaoticBot","phone":"+18882223434"},"db":{"username":"xio","password":"","host":"","port":"","name":"","uri":""},"githubrepo":{"reponame":"test","token":"e967e0c644f48492c3c473db29b3adbb2ded5e1f","repos_url":"http://localhost:3000/api/github/repos/strategicmarket","issues_url":"http://localhost:3000/api/github/issues/strategicmarket"},"sessionSecret":"","facebook":{"clientID":"","clientSecret":"","callbackURL":"/auth/facebook/callback","profileFields":["id","displayName","photos"]},"twitter":{"consumerKey":"","consumerSecret":"","token":"","tokenSecret":"","callbackURL":"/auth/twitter/callback","username":"@chaoticbots","profileFields":["id","displayName","photos"]},"twilio":{"sid":"","token":"","tokenSecret":"","username":"","chaotic":""},"redis":{"host":"","port":12345,"password":""},"chaoticsms":{"host":"http://localhost","port":"3000","url":"http://localhost:3000"},"watsonclassifier":{"description":"The intentionsv3 training dataset demonstration","url":"","username":"","password":"","classifier1":""},"testdb":{"url":"http://localhost:5002/api/agent","uri":"mongodb://localhost:27017/chaoticbots"},"port":3000,"token":""}
